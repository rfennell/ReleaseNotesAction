        ...
        var promise = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                if (process.argv.length !== 14 && process.argv.length !== 16) {
                    console.error('USAGE: node LocalTester.js --pat <GitHub-PAT> --owner <Repo owner> --repo <Repo> --runid <Number> --templatefile <File path> --outputfile <File path> --extensionsFile <Optional Full File path>');
                }
                else {
...
function obfuscatePasswordForLog(value, charToShow = 4, charToUse = '*') {
    var returnValue = '';
