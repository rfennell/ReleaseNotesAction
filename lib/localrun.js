        ...
        var promise = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                if (process.argv.length !== 14) {
                    console.error('USAGE: node LocalTester.js --pat <GitHub-PAT> --owner <Repo owner> --repo <Repo> --runid <Number> --templatefile <File path> --outputfile <File path>');
                }
                else {
                    ...
                    yield releaseNotesModule.generate(octokit, owner, repo, runid, templatefile, outputfile);
                }
            }
            catch (err) {
                console.error(err);
