...
const core = __importStar(__nccwpck_require__(311));
...
function ProcessTemplate(template, extensionsFile, runDetails) {
    ...
    if (template.length > 0) {
        ...
        const handlebars = __nccwpck_require__(472);
        const helpers = __nccwpck_require__(379)({
    ...
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield octokit.issues.listComments({
                    owner: owner,
                    repo: repo,
                ...
                if (response.resource && response.resource.timelineItems) {
                    ...
                    for (const [issue, count] of Object.entries(issues)) {
                        if (count % 2 !== 0) {
                            ...
                            const issueDetails = yield octokit.issues.get({
                                owner: owner,
                                repo: repo,
                                issue_number: issue
                            });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.run = void 0;
const releaseNotesModule = __importStar(__nccwpck_require__(874));
const core = __importStar(__nccwpck_require__(311));
const github = __importStar(__nccwpck_require__(330));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
...
module.exports = eval("require")("handlebars-helpers");
...
/******/ 	return __nccwpck_require__(255);
/******/ })()
;
